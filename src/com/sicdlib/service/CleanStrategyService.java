...
public class CleanStrategyService extends DefaultEntityManager<CleanStrategyEntity> {
    public List<List<CleanStrategyEntity>> getStrategies(){
        ...
        String hql1 = "from CleanStrategyEntity strategy where strategy.type = '1' and strategy.isUse = '1'";
        String hql2 = "from CleanStrategyEntity strategy where strategy.type = '2' and strategy.isUse = '1'";
        String hql3 = "from CleanStrategyEntity strategy where strategy.type = '3' and strategy.isUse = '1'";
        String hql4 = "from CleanStrategyEntity strategy where strategy.type = '4' and strategy.isUse = '1'";
        String hql5 = "from CleanStrategyEntity strategy where strategy.type = '5' and strategy.isUse = '1'";
