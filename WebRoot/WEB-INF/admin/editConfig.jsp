         ...
         <div class="widget-box">
             ...
             <div class="widget-content nopadding">
                 <form class="form-horizontal" method="post" action="editConfig" name="basic_validate" id="basic_validate" novalidate="novalidate">
                     ...
                     <input type="text" readonly="readonly" name="spiderConfigId" id="spiderConfigId" value="">

                     <div class="control-group">
                         <label class="control-label">配置名称</label>
                         <div class="controls">
                             <input type="text" name="configName" id="configName" value="">
                         </div>
                     </div>
                    ...
                    <c:forEach items="${configItemList}" var="v">
                        <c:if test="${v.type eq 'int'}">
                            <div class="control-group">
                             ...
                             <div class="controls">
                                 <input type="text" value="${v.configItemId}" name="${v.configItemId}" >
