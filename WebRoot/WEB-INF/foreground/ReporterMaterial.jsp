                    ...
                    <div class="sx_updown clearfix">
                        ...
                        <div class="row-fluid" style="width:72%;">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form action="<%=basePath%>reporterEdit" method="post">
                                            ...
                                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered dataTable" id="example" aria-describedby="example_info">
                                                    ...
                                                    <tr class="gradeA odd">
                                                        ...
                                                        <td class=" "><input class="uniform_on" type="checkbox" name="objectId" value="1"></td>
                                                    </tr>
                                                    <tr class="gradeA odd">
                                                        <td class="  sorting_1">1</td>
                                                        <td class=" ">十九大召开</td>
                                            ...
                                            <button type="submit" class="btn btn-warning btn-large" style="margin-left:30%">素材选择 >></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
