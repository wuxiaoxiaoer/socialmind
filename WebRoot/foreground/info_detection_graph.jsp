    ...
    <div class="row-fluid">
        <div class="span3" id="sidebar">
            <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                <li>
                    <a href="#001"><i class="icon-chevron-right"></i> 媒体活跃度</a>
                </li>
                <li>
                    <a href="#002"><i class="icon-chevron-right"></i>信息走势图</a>
                </li>
                <li>
                    <a href="#003"><i class="icon-chevron-right"></i> 信息属性走势图</a>
                </li>
                <li>
                    <a href="#004"><i class="icon-chevron-right"></i>数据类型</a>
                </li>
                <li>
                    <a href="#005"><i class="icon-chevron-right"></i>信息属性分布图</a>
                </li>
                <li>
                    <a href="#006"><i class="icon-chevron-right"></i>来源类型统计图</a>
                </li>
                <li>
                    <a href="#007"><i class="icon-chevron-right"></i>地域分布图</a>
                </li>
        ...
        <div class="span9" id="content">
            ...
            <div class="row-fluid">
                ...
                <div class="alert alert-info alert-block">
                    <div> 统计时间10-24 00:00:00~10-24 11:53:51</div>
                </div>
                    ...
                    <div class="span6">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header" id="001">
                                <div class="muted pull-left">媒体活跃度前10</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div id="hero-bar" style="width:100%;height:250px"></div>
                    ...
                    <div class="span6">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">媒体活跃度Top10占比</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div style="width:100%;height:250px"><img src="./images/媒体活跃度前10占比.png"/></div>
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left" id="002">信息走势图</div>
                ...
                <div class="row-fluid">
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left" id="003">信息属性走势图</div>
                            <div class="pull-right"><span class="badge badge-warning">View More</span>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <img src="./images/信息属性走势图.png"></img>
                            </div>
                        </div>
                    </div>
                    <!-- /block -->
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header" id="006">
                                <div class="muted pull-left">信息属性分布图</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div style="width:100%;height:250px"><img src="./images/信息属性分布图.png"/></div>
                    ...
                    <div class="span6">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <div style="width:100%;height:250px"><img src="./images/来源类型统计图.png"/></div>
                ...
                <div class="row-fluid">
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left" id="007">地域分布图</div>
                            <div class="pull-right"><span class="badge badge-warning">View More</span>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <img src="./images/地域分布图.png"/>
                                <img src="./images/1.png" width="250px"></img>
                            </div>
                        </div>
                    </div>
                    <!-- /block -->
