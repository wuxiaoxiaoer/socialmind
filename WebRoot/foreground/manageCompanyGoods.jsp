            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">企业产品</div>
                    </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">新增产品</div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">产品类型</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" type="text" value="产品名称...">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea rows="8" style="width: 270px;">产品简介</textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">产品关键词</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" type="text" value="以逗号分割...">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">产品主页</label>
                                            <div class="controls">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">产品关键词</div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form class="form-horizontal">
