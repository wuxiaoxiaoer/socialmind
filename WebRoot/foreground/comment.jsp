...
<div class="container-fluid" style="padding-top:100px">
    ...
    <h2><center><a herf="#">十九大召开</a></center> </h2><br/><br/>
    ...
    <div class="commentAll" >
        ...
        <div class="reviewArea clearfix">
            <textarea class="content comment-input" placeholder="请输入留言;" onkeyup="keyUP(this)"></textarea>
            <a href="javascript:;" class="plBtn">发布</a>
        </div>
        <!--评论区域 end-->
        <!--回复区域 begin-->
            ...
            <div class="comment-show-con clearfix">
                ...
                <div class="comment-show-con-list pull-left clearfix">
                    ...
                    <div style="margin-left:6px;">
                        <span class="date-dz-left pull-left comment-time">7条回复&nbsp <a href="#">展开↓↓</a></span>
                    </div>
