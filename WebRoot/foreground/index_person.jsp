...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span3" id="sidebar" style="float:right;">
            <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                <li class="">
                    <a><b>欢迎您的参与</b></a>
                    <a>事件名称：十九大召开</a>
                    <a> 感觉不错：<button class="btn btn-success btn-mini">点赞</button>&nbsp&nbsp<button class="btn btn-warning btn-mini">收藏</button></a>
                    <a>判别真假：<button class="btn btn-danger">真</button>&nbsp&nbsp <button class="btn btn-inverse">假</button>
                    </a>
                    <a> 评论留言:</a>
                    <textarea rows="8" cols="40">对事件进行评论...</textarea>
                ...
                <li class="" style="margin-top: 6px;">
                    <a><b>最新留言详情</b></a>
                    <a>1 用户名：小明</a>
                    <a>留言内容: 十九大胜利召开，中国进入了新时代！</a>
                    <a><button class="btn btn-success btn-mini">10赞</button>
                        <button class="btn btn-danger btn-mini">20真</button>
                        <button class="btn btn-inverse btn-mini">10假</button>
                        <button class="btn btn-warning btn-mini">10回复</button>
                    </a>
                </li>
                <li class="" style="margin-top: 6px;">
                    <a>2 用户名：小明</a>
                ...
                <li class="">
                    <button class="btn" style="float: right;">查看详情...</button>
                </li>
            </ul>
        </div>
        ...
        <div class="span9" id="content">
            <div class="row-fluid">
                ...
                <div class="navbar">
                    <div class="navbar-inner">
                        <ul class="breadcrumb">
                            <i class="icon-chevron-left hide-sidebar" style="float: right; width: 140px; background-image: none;">
                                <div class="pull-right"><span class="badge badge-info" style="background-color:#ec110d">&nbsp;留言&nbsp;点赞&nbsp;判别真假</span></div></i>
                            <i class="icon-chevron-right show-sidebar" style="display:none; float: right;width: 140px; background-image: none;"><div class="pull-right"><span class="badge badge-info">&nbsp;留言&nbsp;点赞&nbsp;判别真假</span></div></i>
                            <li>
