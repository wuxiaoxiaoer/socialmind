            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">领导动态管理</div>
                    </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">新增领导人物</div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form class="form-horizontal">
                                    <fieldset>
                                        <legend>新增领导人物</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">人物名称</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" type="text" value="人名...">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">人物主页</label>
                                            <div class="controls">
