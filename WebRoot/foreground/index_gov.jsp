    ...
    <div class="row-fluid">
        <div class="span3" id="sidebar" style="float:right;">
            <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                ...
                <li class="">
                    <button class="btn" style="float: right;" onclick="javascript:window.location.href='comment.html'">查看详情...</button>
                </li>
            </ul>
        </div>
                    ...
                    <div class="navbar-inner">
                        <ul class="breadcrumb">
                            <i class="icon-chevron-left hide-sidebar" style="float: right; width: 140px; background-image: none;">
                                <div class="pull-right"><span class="badge badge-info" style="background-color:#ec110d">点击收起&nbsp;留言&nbsp;点赞&nbsp;判别真假</span></div></i>
