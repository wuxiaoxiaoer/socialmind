            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">关注的同行事业单位</div>
                    </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">新关注机构</div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">机构名称</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" type="text" value="机构名...">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">机构简介</label>
                                            <div class="controls">
                                                <textarea rows="8" style="width: 270px;">机构简介</textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">机构关键词</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" type="text" value="以逗号分割...">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="focusedInput">机构主页</label>
                                            <div class="controls">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">机构关键词</div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form class="form-horizontal">
